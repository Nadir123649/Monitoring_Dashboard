document.addEventListener("DOMContentLoaded", () => {
  ...
  pieData.forEach((d) => {
    ...
    box.className =
      "flex items-center w-[200px] px-2 md:w-full gap-2 justify-center md:justify-start py-3 mb-2 min-w-[200px] md:min-w-[100%] max-w-[200px] md:max-w-[100%] transition-transform border border-white shadow cursor-pointer border-opacity-20 bg-white/85 rounded-xl";
